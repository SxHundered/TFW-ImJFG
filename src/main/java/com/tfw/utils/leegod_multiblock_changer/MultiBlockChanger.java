package com.tfw.utils.leegod_multiblock_changer;
    ...
    public void start(JavaPlugin plugin) {
        ...
        final Runnable runnable = new Runnable() {
            private final Queue<SimpleChunk> chunksToRefresh = new ArrayDeque<SimpleChunk>() {
                ...
                @Override
                public boolean add(@NotNull SimpleChunk simpleChunk) {
            ...
            public void run() {
                ...
                if (!blockChanges.isEmpty()) {
                    for (int i = 0; i < maxChanges; i++) {
						...
						/*
							i make the block set to nms because its pretty great for performance

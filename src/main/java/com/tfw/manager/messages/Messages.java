...
public enum Messages {
    ...
    STAFF_HELP("SETTINGS.HELP.USAGE"),
    STAFF_PLAYER("SETTINGS.TEAM.STAFF_PLAYER"),
    ALREADY_IN_TEAM("SETTINGS.TEAM.ALREADY_IN_TEAM"),
    ALREADY_NOT_IN_TEAM("SETTINGS.TEAM.ALREADY_NOT_IN_TEAM"),
    TEAM_NOT_FOUND("SETTINGS.TEAM.TEAM_NOT_FOUND"),
    PLAYER_ADDED_TO_TEAM("SETTINGS.TEAM.PLAYER_ADDED_TO_TEAM"),
    YOU_HAVE_BEEN_ADDED("SETTINGS.TEAM.YOU_HAVE_BEEN_ADDED"),
    REMOVED_FROM_TEAM("SETTINGS.TEAM.REMOVED_FROM_TEAM"),
    YOU_HAVE_BEEN_REMOVED("SETTINGS.TEAM.YOU_HAVE_BEEN_REMOVED"),
    TEAM_COLOR("SETTINGS.TEAM.TEAM_COLOR"),
    TEAM_SCORE("SETTINGS.TEAM.TEAM_SCORE"),
    TEAM_SPAWN("SETTINGS.TEAM.TEAM_SPAWN"),
    TEAM_HEART("SETTINGS.TEAM.TEAM_HEART"),
    CONFIGURATION_SAVED("SETTINGS.TEAM.CONFIGURATION_SAVED"),
    TEAM_HELP("SETTINGS.TEAM.HELP"),
    ISCORE_USAGE("SETTINGS.ISCORE.USAGE"),
    ISCORE_ERROR("SETTINGS.ISCORE.ERROR"),
    ISCORE_SUCCESSFULLY("SETTINGS.ISCORE.SUCCESSFULLY"),
